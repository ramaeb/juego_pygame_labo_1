...
class Jugador:
    ...
    def __init__(self, coord_x, coord_y, frame_rate = 100, speed_walk = 3, speed_run = 6, gravity = 16, jump = 32):
        self.__iddle_r = sf.get_surface_from_spritesheet('./assets/img/player/iddle/player_idle.png', 3, 1)
        self.__iddle_l = sf.get_surface_from_spritesheet('./assets/img/player/iddle/player_idle.png', 3, 1, flip=True)
        self.__walk_r = sf.get_surface_from_spritesheet('./assets/img/player/walk/player_walk.png', 9, 1)
        self.__walk_l = sf.get_surface_from_spritesheet('./assets/img/player/walk/player_walk.png', 9, 1, flip=True)
